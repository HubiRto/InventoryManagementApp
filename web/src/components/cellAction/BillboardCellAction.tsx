...
export const BillboardCellAction: React.FC<CellActionProps> = ({data}) => {
    ...
    const onDelete = async () => {
        try {
            ...
            await axios.delete<string>(
                `http://localhost:8080/api/v1/billboards/${data.id}`,
                {
                    headers: {
        ...
        <>
            ...
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuItem onClick={() => navigate(`/dashboard/${storeId}/billboards/${data.id}`)}>
