...
interface ManufacturerCellActionProps {
    data: ManufacturerColumn;
}

export const ManufacturerCellAction: React.FC<ManufacturerCellActionProps> = ({data}) => {
    ...
    const onCopy = (id: string) => {
        ...
        toast.success("Manufacturer Id copied to the clipboard")
    };
    ...
    const onDelete = async () => {
        try {
            ...
            await axios.delete<string>(
                `http://localhost:8080/api/v1/producents/${data.id}`,
                {
                    headers: {
        ...
        <>
            ...
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuItem onClick={() => navigate(`/dashboard/${storeId}/manufacturers/${data.id}`)}>
